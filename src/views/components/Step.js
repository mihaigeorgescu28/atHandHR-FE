...
import { default as svg7 } from '../../assets/img/landing/svg/07.svg';
        ...
        <div className="container">
          <div className="row justify-content-center text-center">
            <div className="col-lg-8">
              <div className="mb-5">
                <h2 className="mb-0"><span className="font-w-4 d-block">Using At Hand HR:</span> A Simple Three-Step Process</h2>
              </div>
            </div>
          </div>
          <div className="row text-center">
            <div className="col-12 col-md-4">
              <div>
                ...
                <h4 className="mt-4 mb-2">Book a Demo</h4>
                <p className="mb-0 text-light">Experience a personalised demonstration of our platform.</p>
              </div>
            </div>
            <div className="col-12 col-md-4 mt-5">
              <div>
                ...
                <h4 className="mt-4 mb-2">Explore Our Features</h4>
                <p className="mb-0 text-light">Discover the capabilities and benefits that At Hand HR offers.</p>
              </div>
            </div>
            <div className="col-12 col-md-4 mt-5 mt-md-0">
              <div>
                ...
                <h4 className="mt-4 mb-2">Get Started</h4>
                <p className="mb-0 text-light">Begin using the platform and unlock its full potential.</p>
              </div>
            </div>
          </div>
        </div>
